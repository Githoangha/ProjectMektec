...
namespace ReadCode
{
    public class Support_SQL_PVI_Server
    {
        ...
        /// <returns></returns>
        public static bool SaveDataToBufferReadcode(int ProgramID, string Code_TagJigNonePCS, string Code_TagJigHavePCS, string codePCS)
        {
            int res = 0;
            using (SQLiteConnection con = new SQLiteConnection(c_varGolbal.str_ConnectDBConffig_FVI_Server))
            {
                ...
                try
                {
                    using (SQLiteCommand cmd = new SQLiteCommand())
                    {
                        ...
                        cmd.CommandText = $"INSERT INTO Readcode(ID_Program, Code_TagJigNonePCS, Code_TagJigHavePCS, CodePCS, Date_Time) VALUES('{ProgramID}', '{Code_TagJigNonePCS}', '{Code_TagJigHavePCS}', '{codePCS}', '{dt}')";
        ...
        public static void SaveStateUploadDataReadCode(int ID_Progarm, string Code_TagJigNonePCS, string Code_TagJigHavePCS, string StatusUpload)
        {
            ...
            SQLiteConnection con = new SQLiteConnection(c_varGolbal.str_ConnectDBConffig_FVI_Server);
            try
            {
        ...
        public static bool SaveStateFviByID(int ID,int StatusUpload)
        {
            bool result = false;
            SQLiteConnection con = new SQLiteConnection(c_varGolbal.str_ConnectDBConffig_FVI_Server);
            try
            {
                ...
                con.Open();
                cmd.Connection = con;
                cmd.CommandText = $"UPDATE Readcode SET StatusFVI ={StatusUpload} " +
                                    $"WHERE ID_Program = {ID} ";
